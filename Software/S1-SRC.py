...
S1_EMBEDDED_STATE_B64 = ""  # S1_EMBEDDED_STATE
try:
...
# Vision requests go out on the API's priority tier. The vision passes do no
# reasoning at all; their whole cost is WRITING the answer, and priority
# processing writes it about half as fast again -- measured on the board
# pass: 126 -> 193 tokens/s, 7.6 s -> 5.0 s for the same 678-token answer.
# It is billed at a higher rate. An account that cannot use it gets one
# refusal, after which every request goes out on the standard tier.
PRIORITY_TIER = True
PRIORITY_TIER_MODELS = (VISION_MODEL,)
_PRIORITY_REFUSED = []


def _service_tier_for(model):
    if PRIORITY_TIER and not _PRIORITY_REFUSED and model in PRIORITY_TIER_MODELS:
        return "priority"
    return None
    ...
    for attempt in range(1, API_RETRIES + 1):
        try:
            ...
            try:
                ...
                if not kwargs:
                    raise
                # A client (or test stub) that does not take the argument.
                resp = client.chat.completions.create(
                    model=model, messages=messages,
                    max_completion_tokens=max_tokens)
            except Exception as e:
                if not kwargs or "service_tier" not in str(e).lower():
                    raise
                print(f"[api] priority tier refused ({str(e)[:80]}) - "
                      f"using the standard tier from now on")
                _PRIORITY_REFUSED.append(True)
                resp = client.chat.completions.create(
                    model=model, messages=messages,
                    max_completion_tokens=max_tokens)
            try:
...
4. Then walk around the object's silhouette, placing EIGHT points in
   order (six for a long thin object), each one ON the object's own edge,
   at its extremes, corners and bends. One decimal place per number.
...
for the fields in this order for exactly that reason: fill them in the
...
1. MEASURE. From the outline you just traced, how many cells across is it?
   Multiply by the cell size in SCALE. Write it down. ("size_in")
2. DESCRIBE, without naming, in at most fifteen words. Say only what is
   physically there: colours and where they are, the shape, rigid or soft,
   what sticks out, what is printed on it, any hinge, clip, button, blade,
   spout or seam. No object word at all in this field. ("looks_like")
...
STRICT JSON only - no markdown, no code fences, no commentary. Keep every
text field short: the robot is waiting on this answer, and every extra word
is time it stands still.

{"objects": [
  {"size_in": "5.5 x 0.6",
   "looks_like": "long thin white cylinder, blue band at one end, narrow blue tip",
   "name": "pen",
   "color": "white and blue",
   "center": "D8",
   "polygon": [[1.6, 7.4], [1.7, 7.2], [6.1, 6.6], [6.2, 6.8], [6.1, 7.0],
               [1.8, 7.6]],
   "desc": "marker pen at a slight angle, tip to the right",
   "aka": ["marker", "felt pen"]},
  {"size_in": "6.8 x 6.5",
   "looks_like": "soft blue creased fabric, paler above a fold, darker below it, one arm out left",
   "name": "blue t-shirt",
   "color": "blue",
   "center": "L13",
   "polygon": [[8.6, 9.8], [12.9, 9.4], [14.1, 10.2], [13.6, 11.3],
               [13.9, 13.9], [13.2, 14.6], [9.0, 14.7], [8.4, 13.5]],
   "desc": "t-shirt face-up, collar toward row 10, hem toward row 15",
   "aka": ["shirt", "tee"]}
]}

Rules:
- polygon: EIGHT points (six for a long thin object) - never more - in
  order around the outline, no self-crossing, ONE decimal place. Put them
  on the extremes and the sharpest corners; the pixels fill in the curve
  between them afterwards. Values from 0 to {N_COLS} (columns) and 0 to
  {N_ROWS} (rows).
...
- size_in: the outline's width x height in inches (cells times the cell size
  from SCALE). It is working, not decoration - it is what stops a 3-inch
  object being called a backpack.
- looks_like: physical description ONLY, at most fifteen words, written
  BEFORE you choose the name, containing no object word.
- name: lowercase, short, and as specific as the picture supports - see
  NAMING above. color: its main colour(s) in two or three words.
- desc: at most twelve words - which way it lies (which end points where),
  and anything printed on it.
- aka: two other everyday words an operator might use for it.
...
STRICT JSON only - no markdown, no code fences, no commentary, and nothing
beyond these fields -- the robot is waiting on this answer:

{"components": [
  {"name": "handle", "polygon": [[col, row], ...], "grip": "hold",
   "aka": ["grip"]},
  {"name": "blade", "polygon": [[col, row], ...], "grip": "avoid",
   "aka": ["edge"]}
]}

- 3 to 6 points per polygon, in order, no self-crossing, one decimal place.
  A point-like landmark (a corner, a sleeve tip) is a small 3-4 point shape.
- grip is "hold" where the gripper may close, "avoid" where it must not,
...
# OFF by default since 2026-09-25. It costs one close-up model call per
# object (~4 s of waiting), and on the reference board it made outlines
# WORSE: close-up re-traces scored mean IoU 0.53-0.56 against careful hand
# truth where the board pass alone scored 0.65-0.69, one pale sock at 0.07
# -- reading absolute cell coordinates off a zoomed crop is harder, not
# easier. Outlines now come from the pixels instead (PIXEL_REFINE, ~0.88),
# and the board pass named all five objects right on every run. The close-
# up can still read printed words a wide shot cannot, which is why the
# Settings toggle stays for a board where naming is the problem.
...
def unclaimed_regions(frame_bgr, grid: Grid, objects, fgmap=None):
    ...
    for lab in range(1, count):
        ...
        if float((blob & claimed).sum()) / area > UNCLAIMED_COVERED:
            continue
        # The same rim rule find_unreported_blobs applies: what runs into
        # the edge of the board is the camera's vignette, the frame's dark
        # border or something off the board -- on the reference board all
        # three regions this used to send for a model call were exactly
        # that, and each call came back empty after a second's wait.
        ys, xs = np.nonzero(blob)
        h_px, w_px = blob.shape
        rim_hits = int((xs == 0).sum() + (ys == 0).sum()
                       + (xs == w_px - 1).sum() + (ys == h_px - 1).sum())
...
# ---------------------------------------------------------------------------
# Pixel refinement: the model says WHICH object and ROUGHLY where; the
# pixels say exactly where its edge is.
#
# Every model outline is a handful of vertices read off printed cell labels,
# and on the reference board (S1_tests/board.png, 4 socks + a metal piece)
# they land at mean IoU 0.66 against careful hand truth, worst 0.37 -- a pale
# sock traced as a thin strip down one side of itself. A close-up re-trace
# does not fix that (measured 0.53-0.56: zooming in makes the coordinates
# WORSE, not better). What does: GrabCut, seeded by the model's own outline.
# Inside the outline, pulled in by PIXREF_CORE cells, is certainly object;
# every OTHER object's outline, pulled in the same way, is certainly not;
# up to PIXREF_GROW cells either side of the line is left for GrabCut's
# colour models to decide. Measured over thirteen independent board passes:
# mean IoU 0.66 -> 0.88, worst improves on every seed, ~0.7-1s for the
# whole board at PIXREF_CELL_PX, objects in parallel (OpenCV releases the
# GIL).
#
# The result replaces the model's outline only when it keeps most of it and
# does not balloon; otherwise the model's outline stands, exactly as before.
# ---------------------------------------------------------------------------
PIXEL_REFINE = True
PIXREF_CELL_PX = 40.0
PIXREF_GROW = 1.5
...
def _grabcut_outline(img, seed_px, others_px, cell_px):
    """One object's outline from the pixels, seeded by the model's outline.

    All coordinates are pixels of `img`. Returns the traced contour as an
    (N, 2) pixel array, or None whenever the result is not trustworthy --
    the caller then keeps the model's outline.
    """
    h, w = img.shape[:2]
    seed = np.zeros((h, w), np.uint8)
    cv2.fillPoly(seed, [np.round(seed_px).astype(np.int32)], 1)
    area0 = float(seed.sum())
    if area0 < 20:
        return None
    outer = cv2.dilate(seed, _disk(PIXREF_GROW * cell_px))
    core = cv2.erode(seed, _disk(PIXREF_CORE * cell_px))
    if core.sum() < 0.15 * area0:
        # A thin object: a full-strength erosion leaves nothing certain.
        core = cv2.erode(seed, _disk(0.15 * cell_px))
    mask = np.full((h, w), cv2.GC_BGD, np.uint8)
    mask[outer > 0] = cv2.GC_PR_BGD
    mask[seed > 0] = cv2.GC_PR_FGD
    for op in others_px:
        om = np.zeros((h, w), np.uint8)
        cv2.fillPoly(om, [np.round(op).astype(np.int32)], 1)
        om = cv2.erode(om, _disk(PIXREF_CORE * cell_px))
        mask[(om > 0) & (core == 0)] = cv2.GC_BGD
    mask[core > 0] = cv2.GC_FGD
    x, y, bw, bh = cv2.boundingRect(outer)
    pad = int(math.ceil(cell_px))
    x0, y0 = max(0, x - pad), max(0, y - pad)
    x1, y1 = min(w, x + bw + pad), min(h, y + bh + pad)
    sub = mask[y0:y1, x0:x1].copy()
    has_fg = ((sub == cv2.GC_FGD) | (sub == cv2.GC_PR_FGD)).any()
    has_bg = ((sub == cv2.GC_BGD) | (sub == cv2.GC_PR_BGD)).any()
    if not (has_fg and has_bg):
        return None
    bgd = np.zeros((1, 65), np.float64)
    fgd = np.zeros((1, 65), np.float64)
    try:
        cv2.grabCut(np.ascontiguousarray(img[y0:y1, x0:x1]), sub, None,
                    bgd, fgd, PIXREF_ITERS, cv2.GC_INIT_WITH_MASK)
    except cv2.error:
        return None
    fg = ((sub == cv2.GC_FGD) | (sub == cv2.GC_PR_FGD)).astype(np.uint8)
    fg = cv2.morphologyEx(fg, cv2.MORPH_CLOSE, _disk(0.08 * cell_px))
    fg = cv2.morphologyEx(fg, cv2.MORPH_OPEN, _disk(0.06 * cell_px))
    count, labels, _, _ = cv2.connectedComponentsWithStats(fg)
    if count <= 1:
        return None
    # The piece that holds the certain core, not the biggest: a patch of
    # board GrabCut got wrong is never the object the model pointed at.
    sub_core = core[y0:y1, x0:x1] > 0
    best = max(range(1, count),
               key=lambda k: int(((labels == k) & sub_core).sum()))
    piece = (labels == best).astype(np.uint8)
    contours, _ = cv2.findContours(piece, cv2.RETR_EXTERNAL,
                                   cv2.CHAIN_APPROX_NONE)
    if not contours:
        return None
    contour = max(contours, key=cv2.contourArea) + np.array([[x0, y0]])
    # Outer contour only: a hole through an object (the eye of an iron, a
    # handle) is still the object, as the vision prompt says.
    filled = np.zeros((h, w), np.uint8)
    cv2.drawContours(filled, [contour], -1, 1, -1)
    area = float(filled.sum())
    if float((filled & seed).sum()) < PIXREF_MIN_KEEP * area0:
        return None
    if area > PIXREF_MAX_GROW * area0:
        return None
    approx = cv2.approxPolyDP(contour, max(1.0, 0.03 * cell_px), True)
    if len(approx) < 3:
        return None
    return approx.reshape(-1, 2).astype(np.float64)


def pixel_refine_objects(frame_bgr, grid: Grid, objects):
    """Snap every model outline to the object's real edge. See PIXEL_REFINE.

    Returns the same list with polygon/center/touches replaced where the
    pixels gave a trustworthy answer; the model's outline is kept in
    "model_polygon" so a bad snap can always be told apart from a bad read.
    """
    if not PIXEL_REFINE or frame_bgr is None or grid is None:
        return objects
    ...
    if not todo:
        return objects
    t0 = time.time()
    cell = max(1.0, min(grid.cell_w, grid.cell_h))
    fh, fw = frame_bgr.shape[:2]
    bx0, by0 = grid.grid_to_pixel(0, 0)
    bx1, by1 = grid.grid_to_pixel(CONFIG.n_cols, CONFIG.n_rows)
    margin = cell * (PIXREF_GROW + 1.0)
    ox = int(max(0, math.floor(min(bx0, bx1) - margin)))
    oy = int(max(0, math.floor(min(by0, by1) - margin)))
    ex = int(min(fw, math.ceil(max(bx0, bx1) + margin)))
    ey = int(min(fh, math.ceil(max(by0, by1) + margin)))
    if ex - ox < 8 or ey - oy < 8:
        return objects
    scale = min(1.0, PIXREF_CELL_PX / cell)
    crop = frame_bgr[oy:ey, ox:ex]
    if crop.ndim == 2:
        crop = cv2.cvtColor(crop, cv2.COLOR_GRAY2BGR)
    small = (cv2.resize(crop, None, fx=scale, fy=scale,
                        interpolation=cv2.INTER_AREA)
             if scale < 1.0 else np.ascontiguousarray(crop))
    cell_px = cell * scale

    def to_px(poly):
        return np.array([((grid.grid_to_pixel(c, r)[0] - ox) * scale,
                          (grid.grid_to_pixel(c, r)[1] - oy) * scale)
                         for c, r in poly], np.float64)

    def to_grid(pts):
        return [[round(float(v), 3) for v in
                 grid.pixel_to_grid(x / scale + ox, y / scale + oy)]
                for x, y in pts]

    seeds = {i: to_px(objects[i]["polygon"]) for i in todo}

    def work(i):
        others = [seeds[j] for j in todo if j != i]
        try:
            return i, _grabcut_outline(small, seeds[i], others, cell_px)
        except Exception as e:
            print(f"[pixels] {objects[i].get('name')}: {e}")
            return i, None

    with ThreadPoolExecutor(max_workers=max(1, min(PIXREF_WORKERS,
                                                   len(todo)))) as pool:
        results = list(pool.map(work, todo))

    moved = 0
    for i, contour in results:
        if contour is None:
            continue
        poly = _sq_polygon_from_raw(to_grid(contour))
        if poly is None:
            continue
        cell_rc, cells, pt = polygon_to_cells(poly)
        if cell_rc is None:
            continue
        o = objects[i]
        o["model_polygon"] = o["polygon"]
        o["polygon"] = poly
        o["center"] = coordinate_name(*cell_rc)
        o["touches"] = ",".join(coordinate_name(*c) for c in cells)
        set_center_pt(o, pt)
        moved += 1
    print(f"[pixels] {moved}/{len(todo)} outline(s) snapped to the object's "
          f"edge in {(time.time() - t0) * 1000:.0f} ms")
    return objects
...
# A plain cloth (towel, napkin, rag...) is folded in exactly two moves:
# middle of its left side onto the middle of its right side, then its
# bottom-right onto its top-right. Those four points -- left_mid, right_mid,
# bottom_right, top_right -- are what the fold actually grips, and are what
# gets published as the cloth's COMPONENTS (cloth_corner_components).
#
# The cloth's four geometric CORNERS (top_left, top_right, bottom_right,
# bottom_left) are only a step on the way there -- the bounding quadrilateral
# read off the outline, with no vision call, used to locate the side
# midpoints and the two right-hand corners the fold actually uses. top_left
# and bottom_left are never gripped and never published; they exist only
# inside cloth_corners()/cloth_fold_points() as working geometry.
CLOTH_CORNER_NAMES = ("top_left", "top_right", "bottom_right", "bottom_left")
# How far in from a corner or an edge the gripper actually closes, in cells.
# A corner is where the cloth ENDS, so a grip aimed exactly there is half
# on bare board; this far in, the jaws close on cloth. The landing point is
# pulled in by the same amount, which is exactly where the gripped point of
# a folded-over edge ends up.
...
def cloth_corners(obj):
    ...
    if len(hull) < 4:
        return None
    # Thin a dense hull (a traced outline has dozens of points) down to the
    # ones that matter, so the exhaustive search below stays instant. A
    # stride (hull[::2]) can skip past a genuine sharp corner depending on
    # where it happens to land in the index order; cv2's polygon simplifier
    # keeps points by how far they sit from the simplified edge instead, so
    # real corners survive regardless of how many points sample the hull.
    if len(hull) > 24:
    ...
    # The hull is counter-clockwise in (col, row) numbers, which on screen
    # (rows run downward) is clockwise: top-left, top-right, bottom-right,
    # bottom-left in turn. Only which corner starts the run is open.
    cyc = best
...
def cloth_fold_points(obj):
    ...
    If `obj["_fold_points_verified"]` is set (verify_cloth_fold_points_for_all
    ran and vision corrected the geometric guess), those four points are
    returned instead of the fresh geometric ones -- the vision check exists
    exactly to catch a case like a wrinkled or folded-under hem where the
    outline's bounding rectangle is not where the fabric's real midpoint is.
    """
    verified = obj.get("_fold_points_verified") if isinstance(obj, dict) else None
...
# The four points published as a cloth's COMPONENTS, in fold order: the
# two grips the SIDE move uses, then the two the LENGTH move uses. Never
# top_left or bottom_left -- the fold never touches them, so they are not
# offered as if they were part of the procedure.
...
# ---------------------------------------------------------------------------
# Cloth fold points, VISION-CHECKED. The geometric guess above (largest-area
# quadrilateral of the outline's hull, then its side midpoints) is exact for
# a rectangle but a real cloth is not always a rectangle -- it wrinkles,
# folds a hem under, or lies with one corner tucked, and a bounding
# quadrilateral fitted to a shape like that can put "the middle of the left
# side" a cell or more off the fabric's actual midpoint. This asks vision to
# look at the real cloth and confirm or correct all four points at once, ONE
# close-up call per cloth, and ONLY on a fold task (needs_cloth_fold_check)
# -- a move-only task never pays for it, matching the same gate the rest of
# the fold-landmark machinery uses.
# ---------------------------------------------------------------------------
CLOTH_FOLD_VERIFY_PROMPT = """
This is a CLOSE-UP of one plain cloth on the robot's board, with four points
marked on it in MAGENTA, each labelled with its role:
  L = middle of the LEFT side (where the robot picks up for the fold's
      first move)
  R = middle of the RIGHT side (where L is placed)
  B = the BOTTOM-RIGHT area (picked up for the fold's second move)
  T = the TOP-RIGHT area (where B is placed)

These were placed by fitting a rectangle to the cloth's outline, which is
exact for a perfect rectangle but can be off on a real, slightly wrinkled or
irregular piece of fabric. Your only job is to say whether each of the four
still lands in the right PLACE on the cloth, and correct any that do not.

## COORDINATES

Cells are lettered across the top and bottom and numbered down both sides,
each with its own name printed in its top-left corner. The names are
ABSOLUTE: this crop starts at column {FIRST_COL} and row {FIRST_ROW}, and a
cell labelled {SAMPLE_CELL} is that same cell of the whole board.
...
## WHAT MAKES EACH POINT RIGHT

- L must sit ON THE FABRIC, at the vertical middle of the cloth's LEFT edge
  - not a corner, not the middle of the whole cloth, the middle of its
  LEFT-hand border specifically.
- R is the same, on the cloth's RIGHT edge, at the same height the fold
  would actually carry L onto.
- B is near the cloth's bottom-right corner, on the fabric.
- T is near the cloth's top-right corner, on the fabric, roughly above B.
- All four ON the cloth, never on bare board beside it.

## ANSWER

STRICT JSON only - no markdown, no code fences, no commentary.

If all four are already correctly placed, say so and write nothing else:

{"ok": true}

If any is wrong, return ALL FOUR points (even the ones that were already
right), corrected:

{"ok": false, "left_mid": [col, row], "right_mid": [col, row],
 "bottom_right": [col, row], "top_right": [col, row]}

- Every value must lie inside this crop: col between {C_LO} and {C_HI}, row
  between {R_LO} and {R_HI}.
- Do not move a point that is already correct - only correct at all if at
  least one of the four is genuinely wrong.
"""


def build_cloth_fold_verify_prompt(region) -> str:
    c0, r0, c1, r1 = region
    sample_c = min(c1 - 1, c0 + (c1 - c0) // 2)
    sample_r = min(r1 - 1, r0 + (r1 - r0) // 2)
    return (CLOTH_FOLD_VERIFY_PROMPT
            .replace("{FIRST_COL}", CONFIG.columns[c0])
            .replace("{FIRST_ROW}", str(CONFIG.rows[r0]))
            .replace("{SAMPLE_CELL}", coordinate_name(sample_c, sample_r))
            .replace("{SAMPLE_POINT}", f"[{sample_c + 0.5}, {sample_r + 0.5}]")
...
_CLOTH_FOLD_MARKER_LABEL = {"left_mid": "L", "right_mid": "R",
                           "bottom_right": "B", "top_right": "T"}


def _mark_cloth_fold_points(crop, region, pts):
    """Draw the four candidate points on a rendered crop, each a magenta
    dot with its one-letter role label -- mutates and returns `crop`."""
    c0, r0, c1, r1 = region
    bh, bw = crop.shape[:2]
    cwf = bw / float(c1 - c0)
    chf = bh / float(r1 - r0)
    ...
    for name in CLOTH_FOLD_POINT_NAMES:
        if name not in pts:
            continue
        col, row = pts[name]
        x = int(round((col - c0) * cwf))
        y = int(round((row - r0) * chf))
        cv2.circle(crop, (x, y), 7, magenta, -1, cv2.LINE_AA)
        cv2.circle(crop, (x, y), 7, (255, 255, 255), 2, cv2.LINE_AA)
        cv2.putText(crop, _CLOTH_FOLD_MARKER_LABEL[name], (x + 10, y - 6),
...
def needs_cloth_fold_check(obj, task) -> bool:
    """A plain cloth, on a fold task, with geometry to check at all."""
    return (is_fold_task(task) and garment_family(obj) == "flat"
            and bool(obj.get("polygon")))


def verify_cloth_fold_points(client, frame_bgr, grid: Grid, obj):
    """Ask vision to confirm or correct one cloth's four fold points.

    Returns a corrected `cloth_fold_points()`-shaped dict (with "corners"
    carried over unchanged, since only the four grip points are checked),
    or None if the call fails, is declined, or its answer cannot be
    trusted -- the geometric guess is always a safe fallback, so nothing
    here is allowed to make the recipe WORSE than not asking at all.
    """
    pts = cloth_fold_points(obj)
    if pts is None or frame_bgr is None or grid is None:
        return None
    poly = obj.get("polygon")
    region = zoom_region_for(poly, grow_frac=REFINE_MARGIN_FRAC)
    crop = render_board_region(frame_bgr, grid, *region,
                               long_side=REFINE_LONG_SIDE, subject_poly=poly)
    if crop is None:
        return None
    marked = _mark_cloth_fold_points(crop.copy(), region, pts)
    b64 = encode_jpeg_b64(marked)
    if b64 is None:
        return None
    try:
        raw = call_model(
            client, model=VISION_MODEL, max_tokens=1000,
            stage=f"Cloth fold points - {obj.get('name', 'cloth')}",
            messages=[{"role": "user", "content": [
                {"type": "text", "text": build_cloth_fold_verify_prompt(region)},
                {"type": "image_url", "image_url": {
                    "url": f"data:image/jpeg;base64,{b64}", "detail": "high"}}]}])
    except Exception as e:
        print(f"[cloth-fold] {obj.get('name')}: check failed ({e}) - "
              f"keeping the geometric guess")
        return None
    ...
    if not isinstance(data, dict) or data.get("ok") is True:
        print(f"[cloth-fold] {obj.get('name')}: geometric fold points confirmed")
        return None

    corrected = {}
    for name in CLOTH_FOLD_POINT_NAMES:
        raw_pt = data.get(name)
        if not (isinstance(raw_pt, (list, tuple)) and len(raw_pt) == 2):
            print(f"[cloth-fold] {obj.get('name')}: correction missing "
                  f"'{name}' - keeping the geometric guess entirely")
            return None
        try:
            x, y = float(raw_pt[0]), float(raw_pt[1])
        except (TypeError, ValueError):
            return None
        c0, r0, c1, r1 = region
        if not (c0 <= x <= c1 and r0 <= y <= r1):
            return None
        # Sanity: a "correction" must not move a point further than the
        # cloth's own span -- past that it is not a correction, it is a
        # different point, and the geometric guess is the safer answer.
        old = pts[name]
        span = max(1.0, math.hypot(pts["right_mid"][0] - pts["left_mid"][0],
                                   pts["bottom_right"][1] - pts["top_right"][1]))
        if math.hypot(x - old[0], y - old[1]) > span:
            print(f"[cloth-fold] {obj.get('name')}: correction to '{name}' "
                  f"moved implausibly far - keeping the geometric guess")
            return None
        corrected[name] = (x, y)
    corrected["corners"] = pts["corners"]
    print(f"[cloth-fold] {obj.get('name')}: fold points corrected by vision")
    return corrected


def verify_cloth_fold_points_for_all(client, frame_bgr, grid, objects, task,
                                     on_stage=None):
    """Run verify_cloth_fold_points for every plain cloth on a fold task, in
    parallel, and attach any correction as obj["_fold_points_verified"].

    Nothing is asked, and nothing changes, for a task that is not a fold or
    for a garment that has a shape -- see needs_cloth_fold_check.
    """
    pending = [i for i, o in enumerate(objects) if needs_cloth_fold_check(o, task)]
    if not pending or frame_bgr is None or grid is None:
        return objects
    if on_stage:
        on_stage("Checking cloth fold points - "
                 + ", ".join(str(objects[i].get("name", "cloth"))
                             for i in pending) + "...")
    results = {}

    def ask(idx):
        try:
            results[idx] = verify_cloth_fold_points(client, frame_bgr, grid,
                                                     objects[idx])
        except Exception as e:
            print(f"[cloth-fold] {objects[idx].get('name')}: {e}")
    ...
    for t in threads:
        t.join(timeout=API_TIMEOUT_S + 10)
    for idx, corrected in results.items():
        if corrected is not None:
            objects[idx]["_fold_points_verified"] = corrected
    return objects
...
# Parts cost one close-up request per object -- 4-6 s of waiting on the
# reference board -- and a task that only MOVES things uses none of them:
# a pickup always closes on the object's top-right corner and a keep goes
# to a cell (enforce_gripper_targets), whatever parts the object has. Parts
# are what a task needs to WORK something: a door or lid to open, a button
# to press, a broom's head, a plate's cavity, a garment's fold landmarks.
# Wording this does not recognise counts as needing them -- a slow answer
# beats a plan that cannot find the start button.
MOVE_ONLY_RE = re.compile(
    r"\b(pick|picks|picked|move|moves|moved|put|puts|place|places|set|tidy|"
    r"tidies|stack|stacks|sort|sorts|arrange|swap|collect|gather|organi[sz]e|"
    r"group|line|clear|keep|bring|take|shift|lift|hand|grab|carry|return|"
    r"relocate|separate|pile|gather|drop)\b", re.I)
PART_TASK_RE = re.compile(
    r"\b(open|opens|close|closes|shut|press|presses|push|turn|switch|start|"
    r"stop|run|load|unload|pour|fill|empty|sweep|mop|wipe|wash|clean|scrub|"
    r"dust|soap|rinse|cut|slice|chop|cook|boil|brew|heat|toast|microwave|bake|"
    r"fold|plug|unplug|flip|store|use|make|water|feed)\b", re.I)
# "iron" is a job ("iron the shirt") or a thing ("move it next to the iron").
IRON_VERB_RE = re.compile(r"\biron(?:s|ing)?\b", re.I)
IRON_NOUN_RE = re.compile(r"\b(?:the|an|a|my|that|this|your)\s+iron\b", re.I)


def task_needs_parts(task) -> bool:
    """False only for a task that just moves things around."""
    text = str(task or "")
    if PART_TASK_RE.search(text):
        return True
    if IRON_VERB_RE.search(IRON_NOUN_RE.sub(" ", text)):
        return True
    return not MOVE_ONLY_RE.search(text)


def parts_wanted(obj, task) -> bool:
    """Does THIS object need its parts looked up for THIS task?

    A plain cloth never does: its four corners come from its own outline
    (cloth_corners). Any other garment needs its fold landmarks only when
    the task folds. Everything else follows task_needs_parts.
    """
    family = garment_family(obj)
    if family == "flat":
        return False
    if family:
        return is_fold_task(task)
    return task_needs_parts(task)
...
def detect_all_parts(client, frame_bgr, grid: Grid, objects, on_progress=None,
    ...
    todo = [i for i, o in enumerate(objects)
            if o.get("polygon") and len(o["polygon"]) >= 3
            and (task is None or parts_wanted(o, task))][:REFINE_MAX_OBJECTS]
...
def parse_vision_json(raw: str):
    ...
    for e in entries:
        ...
        size = str(e.get("size") or "").strip().lower() or "?"
        ...
        if poly is not None:
            ...
            if size == "?":
                # The board pass no longer spends words on a size class; the
                # outline it traced already says, in inches.
                size = size_class(span_in)
...
# How far in from the outline's top-right point the jaws close, in cells: a
# corner is where the object ENDS, so a grip aimed exactly at it is half on
# bare board.
...
def top_right_grip_point(o):
    ...
    Read off the OUTLINE (which is the pixels' own since PIXEL_REFINE), not
    ...
    try:
        ...
        return None
    # Densify so a long straight edge still offers points near the corner.
    dense = []
...
# The gripper's two fixed rules, applied to every plan after the planner
# writes it -- deterministic, no model call, so they hold even when a model
# call fails:
#   PICKUP closes on the object's TOP-RIGHT CORNER (the left jaw is the one
#     that moves), and every goto while it is held is shifted by the same
#     amount, so the object's centre still lands where the plan put it;
#   PRESS on an object with nothing held lands on the object's CENTRE, and
#     a slide that follows is shifted the same way.
# A press with a tool held is that tool touching a surface (wiping,
# sweeping) and is never moved; neither is a press on one of an object's
# own working parts (a button, a door); nor a fold move on a fold task,
# whose cells are the fold recipe's.
...
def enforce_gripper_targets(text: str, objects, task=""):
    ...
    last_goto = None          # (line index, planned cell)
    holding = None            # object idx currently held, or None
...
# The board pass is THREE independent reads of the whole board, sent at
# the same moment, and merged. One read misses or mangles a pale object
# often enough to matter: measured on the four-socks-and-iron board, a
# read drops the harder of the two whitish socks to IoU 0.000 (missed
# outright) more often than not on its own, and even TWO merged reads
# still occasionally have both readers miss the same top edge (worst
# observed 0.62-0.67 mean over several runs). A third parallel read
# measurably tightens the floor further (worst-object mean 0.71-0.74 vs
# 0.71 for two, min case 0.68 vs 0.67) for ~0.6s more wall clock (reads
# run in parallel, so the cost is the SLOWEST read among three instead of
# two, not three times one). All reads go out together, so the wait is
# one read's, never the sum.
BOARD_PASS_READS = 3
# Two reads' outlines of one object overlap by at least this fraction of
# the smaller outline; two DIFFERENT objects never do, because objects do
# not overlap on the board.
READ_DUP_OVERLAP = 0.35


def _outline_overlap(a, b) -> float:
    """Shared area of two objects' outlines over the smaller one's, 0..1."""
    pa, pb = a.get("polygon"), b.get("polygon")
    if not pa or not pb:
        same = (str(a.get("center") or "").upper()
                == str(b.get("center") or "").upper())
        return 1.0 if same and a.get("center") else 0.0
    xs = [p[0] for p in list(pa) + list(pb)]
    ys = [p[1] for p in list(pa) + list(pb)]
    x0, y0 = min(xs), min(ys)
    res = 12.0
    w = int(math.ceil((max(xs) - x0) * res)) + 2
    h = int(math.ceil((max(ys) - y0) * res)) + 2

    def mask(poly):
        m = np.zeros((h, w), np.uint8)
        pts = np.array([[(x - x0) * res, (y - y0) * res] for x, y in poly],
                       np.int32)
        cv2.fillPoly(m, [pts], 1)
        return m

    ma, mb = mask(pa), mask(pb)
    small = float(min(ma.sum(), mb.sum()))
    return float((ma & mb).sum()) / small if small else 0.0


def _union_outline(pa, pb, res=12.0):
    """The pixel union of two overlapping outlines, simplified back to a
    polygon. Used when two reads disagree about one object's true extent --
    the case this exists for is a pale object one read traced as a thin
    sliver of itself; the union recovers what the other read actually saw."""
    xs = [p[0] for p in list(pa) + list(pb)]
    ys = [p[1] for p in list(pa) + list(pb)]
    x0, y0 = min(xs) - 1, min(ys) - 1
    w = int((max(xs) - x0 + 1) * res) + 2
    h = int((max(ys) - y0 + 1) * res) + 2
    m = np.zeros((h, w), np.uint8)
    for poly in (pa, pb):
        pts = np.array([[(x - x0) * res, (y - y0) * res] for x, y in poly],
                       np.int32)
    ...
    c = cv2.approxPolyDP(c, 0.5, True)
    pts = [(p[0][0] / res + x0, p[0][1] / res + y0) for p in c]
    return pts if len(pts) >= 3 else list(pa)


def merge_board_reads(reads):
    """One object list out of several independent reads of the same board.

    Objects are paired across reads by overlapping outlines. Anything only
    one read saw is kept -- that is the point of reading twice; a phantom
    on bare board is second_look's job to drop. Where one read has ONE
    object over what another read has as SEVERAL, the several win: that is
    a lumped pair (two socks traced as one), never a split single object,
    because the prompt reports each physical thing once. Between a one-to-
    one pair whose outlines substantially disagree, their pixel UNION is
    kept (a sliver seed with the whole object recovered from the other
    read beats either read alone); when they roughly agree, the larger
    outline stands. The other read's name, if it differs, goes into "aka".
    """
    reads = [list(r or []) for r in reads]
    if len(reads) <= 1:
    ...
    for other in reads[1:]:
        ...
        for bi, b in enumerate(other):
            for ai, a in enumerate(kept):
                if _outline_overlap(a, b) >= READ_DUP_OVERLAP:
                    links.setdefault(("b", bi), set()).add(("a", ai))
                    links.setdefault(("a", ai), set()).add(("b", bi))
        seen, groups = set(), []
        for node in links:
            if node in seen:
                continue
        ...
        drop_a, add_b = set(), []
        for comp in groups:
            a_ids = sorted(i for side, i in comp if side == "a")
            b_ids = sorted(i for side, i in comp if side == "b")
            if len(b_ids) > len(a_ids):
                drop_a.update(a_ids)
                add_b.extend(b_ids)
            elif len(a_ids) == len(b_ids) == 1:
                a, b = kept[a_ids[0]], other[b_ids[0]]
                pa, pb = a.get("polygon"), b.get("polygon")
                # Whichever outline is LARGER leads -- its own name and
                # identity are the ones kept -- whether the two roughly
                # agree or substantially disagree; when they disagree the
                # geometry itself is replaced by their pixel union (a sliver
                # seed recovers the whole object the other read saw).
                winner, loser = ((b, a) if _poly_area(pb or [])
                                 > _poly_area(pa or []) else (a, b))
                winner = dict(winner)
                if pa and pb and _iou_local(pa, pb) < 0.6:
                    union = _union_outline(pa, pb)
                    cell, cells, pt = polygon_to_cells(union)
                    if cell is not None:
                        winner["polygon"] = union
                        winner["center"] = coordinate_name(*cell)
                        winner["touches"] = ",".join(
                            coordinate_name(*c) for c in cells)
                        set_center_pt(winner, pt)
                alt = clean_object_name(loser.get("name"))
                if alt and alt != clean_object_name(winner.get("name")):
                    winner["aka"] = _clean_aka(
                        list(winner.get("aka") or []) + [alt],
                        clean_object_name(winner.get("name")))
                kept[a_ids[0]] = winner
        linked_b = {i for side, i in links if side == "b"}
        extra = [other[i] for i in range(len(other)) if i not in linked_b]
        kept = ([o for i, o in enumerate(kept) if i not in drop_a]
                + [other[i] for i in add_b] + extra)
        if extra:
            print(f"[vision] the second read found "
                  f"{', '.join(str(o.get('name')) for o in extra)} "
                  f"that the first did not")
    return kept


def _iou_local(pa, pb, res=12.0):
    """IoU of two outlines, for merge_board_reads' agree/disagree check."""
    xs = [p[0] for p in list(pa) + list(pb)]
    ys = [p[1] for p in list(pa) + list(pb)]
    x0, y0 = min(xs) - 1, min(ys) - 1
    w = int((max(xs) - x0 + 1) * res) + 2
...
def run_board_pass(client, labelled_b64, clean_b64, task, grid, reads=None):
    """Pass 1: BOARD_PASS_READS independent reads of the board, in parallel,
    merged. Returns (objects, raw_text).

    One read failing is survivable -- the other still saw the whole board --
    so only every read failing is an error.
    """
    n = max(1, int(BOARD_PASS_READS if reads is None else reads))
    replies = [None] * n
    errors = [None] * n
    content = [{"type": "text",
                "text": build_vision_prompt(task, grid,
                                            two_plates=bool(clean_b64))},
               {"type": "image_url", "image_url": {
                   "url": f"data:image/jpeg;base64,{labelled_b64}",
                   "detail": "high"}}]
    if clean_b64:
        content.append({"type": "image_url", "image_url": {
            "url": f"data:image/jpeg;base64,{clean_b64}", "detail": "high"}})
    ...
    def ask(i):
        try:
            replies[i] = call_model(
                # Reasoning and output share this cap; it only has to be
                # well clear of a crowded board's answer.
                client, model=VISION_MODEL, max_tokens=24000,
                stage="Vision" if n == 1 else f"Vision {i + 1}/{n}",
                messages=[{"role": "user", "content": content}])
        except Exception as e:
            errors[i] = e
    ...
    for t in threads:
        t.start()
    for t in threads:
        t.join(timeout=API_TIMEOUT_S * API_RETRIES + 30)
    got = [r for r in replies if r]
    if not got:
        e = next((e for e in errors if e is not None), None)
        if isinstance(e, ModelError):
            raise e
        raise ModelError(f"Vision failed ({e})" if e else
                         "Vision: no read of the board came back.")
    for i, e in enumerate(errors):
        if e is not None:
            print(f"[vision] read {i + 1}/{n} failed ({e}) - using the other")
    objects = merge_board_reads([parse_vision_json(r) for r in got])
    return objects, "\n".join(got)
...
class AIJob:
    ...
    def _run(self):
        try:
            ...
            objects, raw = run_board_pass(client, b64, clean_b64, self.task,
                                          self.grid)
            if not objects:
            ...
            # The model's outlines, snapped onto the object's real edge in
            # the pixels -- see PIXEL_REFINE. No model call; ~0.7-1s.
            if self.raw_frame is not None and self.grid is not None:
            ...
            #
            # A task like "again", "fold it too" or "do the same" names no
            # verb of its own -- whether it is a fold task (needing parts
            # for a garment's fold landmarks, and later keeping the fold
            # framework's own grip cells rather than the top-right rule)
            # depends on what it is continuing, which is in the
            # conversation history, not the task text. Fall back to the
            # history's own wording only when the task's does not settle it
            # either way on its own. Used for every gate below that asks
            # "is this a fold task" for the rest of this job.
            ...
            if (COMPONENT_PASS and self.raw_frame is not None
                ...
                n = min(REFINE_MAX_OBJECTS,
                        sum(1 for o in objects
                            if o.get("polygon") and len(o["polygon"]) >= 3
                            and parts_wanted(o, effective_task)))
                if n:
                    ...
                    print(object_list_text(objects))
            # A plain cloth's four fold points, from its own (pixel-snapped)
            # outline -- no model call. On a fold task only, vision then
            # checks and can correct all four at once for a cloth that is
            # not a perfect rectangle (a wrinkle, a tucked-under hem) --
            # this is the only extra call add_cloth_corners costs, and it
            # never fires outside a fold task (needs_cloth_fold_check).
            objects = verify_cloth_fold_points_for_all(
                client, self.raw_frame, self.grid, objects, effective_task,
            ...
            # Where the gripper actually closes and presses. This used to be
            # a Gripper AI vision call whose answer was then overridden to
            # the top-right corner anyway -- and when that call failed, no
            # pickup was moved at all. The rule is now applied directly,
            # to every pickup and press, every time.
            if GRIPPER_AI:
...
def draw_object_overlays(frame, grid: Grid, objects, show_names=True,
    ...
    for i, o in enumerate(objects):
        ...
        if not comps and poly and garment_family(o) == "flat":
            # A plain cloth's parts are its four fold grip points (the two
            # side midpoints, then bottom-right and top-right -- never the
            # raw top-left/bottom-left corners), taken from its own outline
            # with no vision call (cloth_corner_components) -- shown here
            # even before the pipeline has attached them.
            comps = cloth_corner_components(o)
